...
const IntensiveHero = () => {
  ...
  return(
    <>
      <section className="w-full flex flex-col items-center pb-2 px-2 pt-[88px] sm:pb-5 md:px-4 2xl:pt-[50px] lg:pb-5">
      <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <button
        className="flex w-full mt-8 items-center border-4 border-blue justify-center text-blue text-2xl font-bold uppercase py-[50px] hover:bg-blue sm:text-3xl md:pl-12 md:text-[52px] group hover:stroke-change transition-colors duration-300"
        >
