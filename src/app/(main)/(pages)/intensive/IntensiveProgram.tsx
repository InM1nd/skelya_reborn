  ...
  const programs = [
    {
      ...
      date: "<b>вебінар</b> / 30 січня / четвер / 19:00",
      points: [
    ...
    },
    {
      ...
      date: "<b>бонусний вебінар з <a href={https://www.linkedin.com/in/moroz-viktoriia/} class='underline'>Вікторією</a>, Tech Recruitment </br> Consultant з Tietoevry</b> / 27 лютого / четвер / 19:00",
      points: [
        "Як аналізувати ринок і типи компаній.",
        "Визначення власної конкурентності.",
        "Створення резюме: структура, найкращі практики"
