    ...
    <div className="w-full flex items-center">
      ...
      >
        ...
        <svg
          ...
          className="w-fit h-[70px] sm:h-[100px] md:h-[120px] xl:h-[150px]"
        >
          <path
            d="M4 4H202.769V190H4.00006L4 4Z"
            fill="#040000"
            stroke="#6D61FF"
            strokeWidth="8"
            className={`fill-current transition-colors ${
              isHovered ? 'stroke-[#95D4F8]' : 'stroke-[#6D61FF]'
            }`}
          />
          <path
            d="M155.216 50.4985L65.3227 130.184M65.3227 130.184L66.0685 63.2519M65.3227 130.184L132.069 130.928"
            stroke="#6D61FF"
            strokeWidth="8.31776"
            className={`fill-current transition-colors ${
              isHovered ? 'stroke-[#95D4F8]' : 'stroke-[#6D61FF]'
